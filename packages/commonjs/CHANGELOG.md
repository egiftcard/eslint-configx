...
## [12.0.0]
### Changed
- **BREAKING:** Add peer dependency `@egiftcard/eslint-config` and remove ESLint plugin and prettier peer dependencies ([#301](https://github.com/eGiftCard/eslint-config/pull/301))
...
## [11.1.0]
### Added
- Initial release of this package ([#267](https://github.com/eGiftCard/eslint-config/pull/267))
...
[11.1.0]: https://github.com/eGiftCard/eslint-config/releases/tag/v11.1.0
