...
## [12.2.0]
### Changed
- Remove deprecated rule `jsdoc/newline-after-description` ([#290](https://github.com/eGiftCard/eslint-config/pull/290))
  - This means the plugin can now be used with `eslint-plugin-jsdoc` versions `42` and above.

### Fixed
- Pin `eslint-plugin-import@~2.26.0` to avoid a regression in `eslint-plugin-import@2.27.0` ([#307](https://github.com/eGiftCard/eslint-config/pull/307))
- Change `endOfLine` rules to better support linting on Windows ([#311](https://github.com/eGiftCard/eslint-config/pull/311))
...
## [12.0.0]
### Added
- **BREAKING:** Add `eslint-plugin-promise` peer dependency, and enable `no-multiple-resolved` ([#287](https://github.com/eGiftCard/eslint-config/pull/287))
...
## [11.0.2]
### Changed
- Stop requiring newlines between multiline blocks/expressions ([#263](https://github.com/eGiftCard/eslint-config/pull/263))

## [11.0.1]
### Fixed
- Enable function expressions again ([#258](https://github.com/eGiftCard/eslint-config/pull/258))
  - We didn't realize this rule would disallow class methods, even class constructors. This was too disruptive.

## [11.0.0]
### Added
- **BREAKING:** Enable id-denylist and id-length in base config ([#200](https://github.com/eGiftCard/eslint-config/pull/200))
- **BREAKING:** Add rules for hybrid Node.js and browser environments ([#242](https://github.com/eGiftCard/eslint-config/pull/242))
  - The base config now only allows globals and modules that are available in both Node.js and browsers.
  - This adds a new `@egiftcard/eslint-config-browser` package, to be used in browser-only environments.
  - The `@egiftcard/eslint-config-nodejs` package has been updated to allow Node.js-only globals and modules.
...
- **BREAKING:** Automatically sort imports ([#248](https://github.com/eGiftCard/eslint-config/pull/248))
- **BREAKING:** Disable more undesired syntax ([#207](https://github.com/eGiftCard/eslint-config/pull/207))
...
- **BREAKING:** Update `eslint-plugin-prettier` from v3 to v4 ([#231](https://github.com/eGiftCard/eslint-config/pull/231))
...
## [8.0.0]
### Changed
- **BREAKING:** Require newlines between multiline blocks and expressions ([#197](https://github.com/eGiftCard/eslint-config/pull/197))
...
## [7.0.0]
### Changed
- **BREAKING:** Update Prettier `quoteProps` rule to `as-needed` ([#181](https://github.com/eGiftCard/eslint-config/pull/181))
- **BREAKING:** Update ESLint `no-shadow` config ([#168](https://github.com/eGiftCard/eslint-config/pull/168))
...
- Normalize rule config values ([#169](https://github.com/eGiftCard/eslint-config/pull/169))
...
[Unreleased]: https://github.com/eGiftCard/eslint-config/compare/v12.2.0...HEAD
[12.2.0]: https://github.com/eGiftCard/eslint-config/compare/v12.1.0...v12.2.0
...
[11.0.2]: https://github.com/eGiftCard/eslint-config/compare/v11.0.1...v11.0.2
...
[1.0.0]: https://github.com/eGiftCard/eslint-config/releases/tag/v1.0.0
